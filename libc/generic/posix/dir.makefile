...
$c_HEADERS := fcntl.h pthread.h sched.h spawn.h strings.h termios.h unistd.h \
...
$c_OBJECTS := fcntl-stubs.o pthread-stubs.o sched-stubs.o spawn-stubs.o strings-stubs.o \
