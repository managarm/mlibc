...
struct PrintfAgent {
	...
	frg::expected<frg::format_error> operator() (Char t, frg::format_options opts,
		...
		case 'c':
			...
			frg::do_printf_chars<F, Char>(*_formatter, t, opts, szmod, _vsp);
			break;
		case 'p': case 's':
			frg::do_printf_chars<F, Char>(*_formatter, t, opts, szmod, _vsp);
			break;
		case 'd': case 'i': case 'o': case 'x': case 'X': case 'b': case 'B': case 'u':
			frg::do_printf_ints<F, Char>(*_formatter, t, opts, szmod, _vsp, locale_opts);
			break;
		case 'f': case 'F': case 'g': case 'G': case 'e': case 'E': case 'a': case 'A':
			frg::do_printf_floats<F, Char>(*_formatter, t, opts, szmod, _vsp, locale_opts);
			break;
		case 'm':
